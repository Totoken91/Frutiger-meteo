...
- **Fond Three.js 100 % génératif** : dégradé animé par shader qui suit la météo
  *et* l'heure réelle (aube, jour, crépuscule, nuit), halo de soleil/lune positionné
  ...
  autour du soleil par ciel dégagé, une couche liquide « lava-lamp »
  (metaballs qui fusionnent, teintée par le ciel), pluie/neige en
  particules GPU, éclairs pendant les orages.
